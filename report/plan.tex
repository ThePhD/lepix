...
\begin{figure}[h!]
	\vspace*{-2cm}
	\makebox[\linewidth]{
		\includegraphics[width=1.3\linewidth]{\detokenize{history/issues.png}}
	}
	\caption{Closed issues throughout the project \url{https://github.com/ThePhD/lepix/issues?q=is\%3Aissue+is\%3Aclosed}.}
	\label{fig:issues}
\end{figure}
...
\begin{figure}[h!]
	\vspace*{-2cm}
	\makebox[\linewidth]{
		\includegraphics[width=1.3\linewidth]{\detokenize{history/milestones.png}}
	}
	\caption{Milestones for the project \url{https://github.com/ThePhD/lepix/milestones?state=closed}.}
	\label{fig:milestones}
\end{figure}

\section{Tools}

Everyone was free to develop in whatever IDE or editor they wished, just so long as they could invoke the makefile. As I was originally the System Architect, I put together a list of all the tools someone would need to invoke the build process in Figure \ref{fig:tools}. The command line dependencies here helped me figure out what was needed when we started to do testing \ref{ch:testing}.

\begin{figure}[h!]
	\vspace*{-2cm}
	\makebox[\linewidth]{
		\includegraphics[width=1.3\linewidth]{\detokenize{history/tools.png}}
	}
	\caption{Tools and development environment setup (\url{https://github.com/ThePhD/lepix/issues/7}).}
	\label{fig:tools}
\end{figure}

\section{Project Log}

Asides from issues being closed and comments being made, the best project log that shows how I did is the git commit log for all the branches, included below. It was generated from git using the command \lstinline|git --no-pager log --graph --abbrev-commit --decorate --date=relative --all|.
